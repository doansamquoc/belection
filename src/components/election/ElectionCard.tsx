...
const ElectionCard = ({ election }: ElectionCardProps) => {
  return (
    <Link to={`/e/${election.id}`} className='group block'>
      <div className='bg-card border rounded-lg p-6 transition-all duration-200 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1 group-hover:bg-card/80'>
